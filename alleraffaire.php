...
require "bdpdoo.php";
   ...
   $req=$pdo->prepare("SELECT v.num_vol, v.nom_aer_dep, v.nom_aer_arr , prix_premiere_adulte, prix_premiere_enfant,prix_premiere_bebe,v.date_depart , v.heure_depart , v.heure_arrivee , TIMEDIFF( `heure_arrivee`, `heure_depart` ) AS Temps , s.classe_siege 
...
group by num_vol
 ");
 $req->execute([$depart,$arriver,$post_date]);
...
limit 4
 ');
 $req2->execute([$depart,$arriver,$post_date]);
                ...
                $num_vol = $row['num_vol'] ;
                    ...
                    $var++; ?>
	 	                    ...
	 	                    <div class="row"  style="border-bottom:7px solid #365390;margin-top:30px;margin-bottom:10px">
									 ...
									 <!--colonne 3-->
                                     <div class="col-sm-2" style=" border:1px solid #365390;height:88px;padding-top:15px;margin-right:2px;font-size:17px"><?php echo           $_SESSION['pri']  ; ?> DA</br> 
                                                  ...
                                                  <div class="modal-content">
                                                     ...
                                                     <div class="modal-body"">
		                                                 ...
		                                                 <div class="row" style="pading-top:10px">
                                                             ...
                                                             <div class="col-sm-12" style="margin-top:10px"><h4 class="text-center">Prix:  <?php echo            $_SESSION['pri'] ; ?>DA</h4></div>
			                                             </div>
                                     ...
                                     <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                             ...
                                             <div class="modal-footer">
                                                <a href="retouraffaire.php?num_vol=<?php echo $num_vol ; ?>" class="btn"style="background-color:#808080;color:white"> Oui </a> 
