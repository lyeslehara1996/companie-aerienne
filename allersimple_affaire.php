                ...
                $_SESSION['clas']=$row['classe_siege'] ;
                    ...
                    $var++; ?>
	 	                    ...
	 	                    <div class="row"  style="border-bottom:7px solid #365390;margin-top:30px;margin-bottom:10px">
									 ...
									 <!--colonne 3-->
                                     <div class="col-sm-2" style=" border:1px solid #365390;height:88px;padding-top:15px;margin-right:2px;font-size:17px"><?php echo           $_SESSION['id4']  ; ?> DA</br> 
                                             ...
                                             <div class="modal-lg modal-dialog  modal-dialog-centered mx-auto">
                                                 ...
                                                 ?>
		                                                 ...
		                                                 <div class="row" style="pading-top:10px">
                                                             ...
                                                             <div class="col-sm-12" style="margin-top:10px"><h4 class="text-center">Prix:  <?php echo           $_SESSION['id4']  ; ?>DA</h4></div>
			                                             </div>
                                     ...
                                     <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                             ...
                                             <div class="modal-footer">
                                                 <a href="reservationsimpleAff.php?num_vol=<?php echo $row['num_vol'] ; ?>">Oui </a>
