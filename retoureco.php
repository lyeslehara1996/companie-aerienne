...
$post_date1 = $_SESSION['date2'];
    ...
    $req= "SELECT v.num_vol, v.nom_aer_dep, v.nom_aer_arr , prix_eco_adulte, prix_eco_enfant,prix_eco_bebe,v.date_depart , v.heure_depart , v.heure_arrivee , TIMEDIFF( `heure_arrivee`, `heure_depart` ) AS Temps , s.classe_siege
                  ...
                  $prixa = $row['prix_eco_adulte'];
                    ...
                    $var++; ?>
	 	                    ...
	 	                    <div class="row"  style="border-bottom:7px solid #365390;margin-top:30px;margin-bottom:10px">
									 ...
									 <!--colonne 3-->
                                     <div class="col-sm-2" style=" border:1px solid #365390;height:88px;padding-top:15px;margin-right:2px;font-size:17px"><?php echo           $_SESSION['prixA']  ; ?> DA</br> 
                                                  ...
                                                  <div class="modal-content">
                                                     ...
                                                     <div class="modal-body"">
		                                                 ...
		                                                 <div class="row" style="pading-top:10px">
                                                             ...
                                                             <div class="col-sm-12" style="margin-top:10px"><h4 class="text-center">Prix:  <?php echo           $_SESSION['prixA']  ; ?>DA</h4></div>
			                                             </div>
                                     ...
                                     <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                             ...
                                             <div class="modal-footer">
                                                    <a href="reservationRetour.php?num_vol=<?php echo $row['num_vol'] ;?>" class="btn"style="background-color:#808080;color:white"> Oui </a>
