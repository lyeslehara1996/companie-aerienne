...
limit 4
 ');
    ...
    $_SESSION['id4'] = $prix_total;

    $prixTAFF = $_SESSION['id4'];
    ?>
         ...
         <div class="row">
          ...
          <div class="d-inline"><i class='fas fa-male mr-1' style="margin-left:7px;color: #365390;"></i><?php echo $adulte; ?></div>
           ...
           <div class="col">
            ...
            <div class="p-2 bg d-inline"><strong  style="font-size: 20px;"><?php $prixTAFF;?> DA</strong></div>
            </div>
         </div>
         <div class="row">
          <div class="col">
...
<div class="col-12 col-md-10 shadow">
    ...
    <form action="paiementsimpAFF.php" method="post">
         ...
         <h4><?php echo $i + 1; ?><sup>er</sup> passager</h4>
            <div>
              ...
              <i class="far fa-calendar-alt text-muted"></i>
                             ...
                             <input type="date" id="dtnEE" name="dtnE[]" class="form-control form-control-sm bg-white border-left-0 border-md" placeholder="Date depart " required>
                            <br>
                        </div>
                    </div>
