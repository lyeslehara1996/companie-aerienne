      ...
      <div class=" pos col-12 col-sm-12 col-md-12 col-lg-12 p-0" >
        <div class=" pan mx-auto col-12 col-sm-12 col-md-12 col-lg-12  ">
          ...
          <div id="pres"class=" pan1 pan col-12 col-lg-12 col-sm-12 col-md-12 tes mt-4">
            ...
            <form autocomplete="off"  action="allerRetour.php" method="post" id="form_register" class="row col-12 col-sm-12 col-lg-12 col xl-12  p-0">
...
<!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!----><!---->
    ...
    <section class="mb-5 col-lg-12" >
      ...
      <p class="  mb-5 mt-3 " style="color: #365390;font-size: 15px">Avant le 29 Décembre 2019</p></h4>
...
<input type="hidden" name="madate" value="2020/01/24">
...
<script>
 ...
 <script type="text/javascript">
    var countries = ["ALGER","BANGKOK","BARCELONE","BEIRUT","HAMBURG","ISTAMBUL","KUALA LUMPUR","LAS-VEGAS","LYON","MARRAKECH","MONTREAL","PARIS","RABAT","STOCKHOLM","STRASBOURG"];
</script>
...
<script>
autocomplete(document.getElementById("depart"), countries);
