...
if (isset($_POST['valider'])) {
 ...
 require 'bd.php';
    ...
    VALUES ('$numero_carte', '$date_res', '$heure_res','$adulte','$enfant','$bebe', '$montant', '$num_volA','$num_volA','$num_client', '$classe', 0  )";
                $query = $connection->query($reserv);
      $select_reser = "SELECT`num_res` FROM reservation WHERE num_client = (SELECT MAX(num_client) FROM client)
                ";
...
<div class="breadcrumb col-12 text-center">
    ...
    <a href="#" class="col-4 " style="cursor: auto;">Informations</a>
    <a href="#" class=" col-4 active"  style="cursor: auto;">Paiment</a>
      ...
      <!--formulaire-->
       <div class="container contenu">
           <form action="billetAS2.php "method="POST"class="formulaire">
           ...
           <div class="col-md-7 register-left">
            ...
            <div class="register-form">
              <div class="form-group">
                ...
                <input type="month"id="date" name="date" class="form-control date" placeholder="12/12/2019">
              ...
              <div class="form-group">
                ...
                <input  name="pwd" type="text"id="pwd" class="form-control pwd" placeholder="">
                <div class="erreurpwd"id="erreurpwd"></div>
              </div>
            </div>
              <button type="submit"id="submit" class="btn btn-primary btn-voirplus submit" name ="valiider" style="margin-right: 35px;">Valider</button>
            </div>
