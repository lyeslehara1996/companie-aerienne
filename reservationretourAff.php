...
while ($row = $req->fetch(PDO::FETCH_ASSOC)) {
    ...
    $_SESSION['num_volr'] = $row['num_vol'];
    $volR = $_SESSION['num_volr'];
 ...
 ');
    $req2->execute([$numvolA]);

    $req3 = $pdo->prepare('SELECT * from vol v ,avion a ,siege s , escale e
                where v.matricule_avion = a.matricule_avion
                and a.matricule_avion = s.matricule_avion
                and s.classe_siege="premiere"
                and e.num_vol=?
 ...
 ');
    ...
    $reqpri = $pdo->prepare('SELECT  prix_premiere_adulte, prix_premiere_enfant,prix_premiere_bebe from vol v
                where v.num_vol=? ');
    $reqpri->execute([$numvolA]);
    $rowss = $reqpri->fetch();
    $prixa = $rowss['prix_premiere_adulte'];

    $nbr = $rowss['prix_premiere_enfant'];
    $beb = $rowss['prix_premiere_bebe'];
    $prixt = $adulte * $prixa;
    ...
    $reqpr = $pdo->prepare('SELECT  prix_premiere_adulte, prix_premiere_enfant,prix_premiere_bebe from vol v
                where v.num_vol=? ');
    $reqpr->execute([$volR]);

    $ro = $reqpr->fetch();
    $prixar = $ro['prix_premiere_adulte'];
    $nbrr = $ro['prix_premiere_enfant'];
    $bebr = $ro['prix_premiere_bebe'];
    $prixtr = $adulte * $prixar;
    $priter = $enfant * $nbrr;
    $prixbr = $bebe * $bebr;
    $prix_totalr = $prixtr + $priter + $prixbr;
    $prixT = $prix_totalr + $prix_total;
    $_SESSION['prixtotat'] = $prixT;
...
<link rel="stylesheet" type="text/css" href="css/loading.css">
    ...
    <link rel="stylesheet"  href="formcss/menu.css">
...
<div class="breadcrumb col-12">
    ...
    <a href="#" class="col-4 active">Informations</a>
    ...
    <div id="accordion">
      <div class="card bg-white shadow rounded">
        ...
        <div class="card-header">
             ...
             <i class="fa fa-check-circle float-right mr-5" style="font-size: 29px;color: #f9a602;"></i>
        ...
        ?>
            ...
            <div class="p-2 bg d-inline"><?php echo $rows['heure_depart']; ?></div><?php }?>
                    ...
                    <h4 class="d-inline " style="background-color:#f9a602; "><strong>Vol Retour</strong></h4><br>

            <div class="row">
            <div class="col">
            <div class="p-2 bg d-inline"><i class='fas fa-plane-departure mr-2' style='color:#365390'></i><?php echo $row['nom_aer_dep'] ?></div>
             <div class="p-2 bg d-inline"><?php echo $row['heure_depart'] ?></div>

             </div>
              <div class="col">
             <div class="p-2 bg d-inline"><i class='far fa-calendar-alt mr-2' style="color: #365390;"></i><?php echo $row['date_depart'] ?></div>
           </div>
         </div>
         <div class="row">
          <div class="col">
          <div class="p-2 bg d-inline"><i class='fas fa-plane-arrival mr-2' style='color:#365390'></i><?php echo $row['nom_aer_arr'] ?></div>
             <div class="p-2 bg d-inline"><?php echo $row['heure_arrivee'] ?> </div>
           </div>
           <div class="col">
              <div class="p-2 bg d-inline"><i class='fas fa-stopwatch mr-2 ' style="color: #365390;"></i><?php echo $row['Temps'] ?></div>
            </div>
          ...
          <div class="d-inline"><i class='fas fa-male mr-1' style="margin-left:7px;color: #365390;"></i><?php echo $adulte; ?></div>
              ...
              <?php if ($enfant > 0) {?>
               <div class="d-inline"><i class='fas fa-child mr-1' style="margin-left:7px;color: #365390;"></i><?php echo $enfant; ?></div>
                                   <?php }?>
                 <?php if ($bebe > 0) {?>
               <div class="d-inline"><i class='fas fa-baby mr-1' style="margin-left:7px;color: #365390;"></i><?php echo $bebe; ?></div>
                   <?php }?>
           </div>
    ...
    if ($rows = $req3->fetch()) {
        ?>
          ...
          <div class="col">
            <div class="p-2 bg d-inline"><h4 class="d-inline">Montant total</h4></div>
            <div class="p-2 bg d-inline"><h4 class="d-inline"><strong><?php echo $prixT; ?> DA</strong></h4></div>
            </div>
...
<div class="col-12 col-md-10 shadow">
    ...
    <form action="paiementretourAff.php" method="post">
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input class="form-control bg-white border-left-0 border-md" type="text" id="nom" name="nom[]" placeholder="Saisissez votre nom" required>
                    </div>
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input class="form-control bg-white border-left-0 border-md" type="text" id="prenom" name="prenom[]" placeholder="Saisissez votre prénom" required>
                    </div>
         ...
         <h4><?php echo $i + 1; ?><sup>er</sup> passager</h4>
            <div>
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input class="form-control bg-white border-left-0 border-md" type="text" id="nomEE" name="nomE[]" placeholder="Saisissez votre nom" required>
                    </div>
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input class="form-control bg-white border-left-0 border-md" type="text" id="prenomEE" name="prenomE[]" placeholder="Saisissez votre prénom" required>
                    </div>
                     <span style="margin-left: 4.1rem" id="erreuprernomEE"></span>
                  </div>
                </div>
              ...
              <i class="far fa-calendar-alt text-muted"></i>
                           ...
                           <input type="text" id="dtnEE" name="dtnE[]" class="form-control form-control-sm bg-white border-left-0 border-md" placeholder="Date depart " required>
                            <br>
                        </div>
                    </div>
         ...
         <h4><?php echo $i + 1; ?><sup>er</sup> passager</h4>
            <div >
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input class="form-control bg-white border-left-0 border-md" type="text" id="nomBB" name="nomB[]" placeholder="Saisissez votre nom"required >
                    </div>
                ...
                <div class="col-12 col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-2">
                      ...
                      <input class="form-control bg-white border-left-0 border-md" type="text" id="prenomBB" name="prenomB[]" placeholder="Saisissez votre prénom" required>
                    </div>
              ...
              <i class="far fa-calendar-alt text-muted"></i>
                          ...
                          <input type="date" id="dtnBB" name="dtnB[]" class="form-control form-control-sm bg-white border-left-0 border-md" placeholder="Date depart " required>
                            <br>
                        </div>
                    </div>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input class="form-control bg-white border-left-0 border-md" type="email" id="mail" name="email" placeholder="Saisissez votre e-mail" required>
                  </div>
              ...
              <div class="col-12 col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group mb-2">
                    ...
                    <input class="form-control bg-white border-left-0 border-md" type="email" id="emailConf" placeholder="Confirmez votre e-mail" required>
                  </div>
...
<div class="col-4 mt-4">
 <button type="submit" name="valider" class="btn btn-primary float-right continuer mr-5">Continuer</button>
   ...
   <?php }?>
    ...
    <script src="js/lightpick1.js"></script>
