...
while ($row = $req->fetch(PDO::FETCH_ASSOC)) {
 ...
 ');
    ...
    $reqpr = $pdo->prepare('SELECT prix_eco_adulte, prix_eco_enfant,prix_eco_bebe from vol v
                where v.num_vol=? ');
    $reqpr->execute([$volR]);
    $ro = $reqpr->fetch();
    $prixar = $ro['prix_eco_adulte'];
    $nbrr = $ro['prix_eco_enfant'];
    $bebr = $ro['prix_eco_bebe'];
    $prixtr = $adulte * $prixar;
    $priter = $enfant * $nbrr;
    $prixbr = $bebe * $bebr;
    $prix_totalr = $prixtr + $priter + $prixbr;
    $prixT = $prix_totalr + $prix_total;
    $_SESSION['prixtott'] = $prixT;
...
<div class="col-12 col-md-10 shadow">
    ...
    <form action="paiementretour.php" method="post">
